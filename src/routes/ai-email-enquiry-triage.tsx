...
const workflowPhases: WorkflowPhase[] = [
  {
    ...
    image: WF_BASE + "Phase-1-" + WF_SUFFIX,
  },
  {
    label: "Phase 2",
    ...
    image: WF_BASE + "Phase-2-" + WF_SUFFIX,
  },
  {
    label: "Phase 3",
    ...
    image: WF_BASE + "Phase-3-" + WF_SUFFIX,
  },
  {
    label: "Fork A",
    ...
    image: WF_BASE + "Complaint-Handling-" + WF_SUFFIX,
  },
  {
    label: "Fork B",
    ...
    image: WF_BASE + "Parts-Pricing-Scheduling-" + WF_SUFFIX,
  },
];
