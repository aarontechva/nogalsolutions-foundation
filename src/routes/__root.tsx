...
import themeInitScript from "../lib/theme-init.ts?raw";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      { rel: "icon", type: "image/png", sizes: "32x32", href: "/favicon-v2-32x32.png" },
      { rel: "icon", type: "image/png", sizes: "512x512", href: "/favicon-v2.png" },
...
function RootShell({ children }: { children: ReactNode }) {
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        <HeadContent />
        {/* Must run before paint to set the dark/light class and avoid a flash of the wrong theme. */}
